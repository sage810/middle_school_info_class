...
description: >
  ...
  guide/activity.md 1부(활동 유형 가이드)의 활동 유형 카탈로그(§1 구현됨 / §3 확장 아이디어)와 guide/design.md 를 근거로
...
1. `guide/activity.md` 1부(활동 유형 가이드) — §1 이미 구현된 활동 유형(빈칸/객관식/OX/드래그 짝짓기/흐름도/콜아웃/표/복사방지),
